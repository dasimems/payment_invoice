...
final class SMimeEncrypter extends SMime
{
     ...
     * @param int|null        $cipher      A set of algorithms used to encrypt the message. Must be one of these PHP constants: http://www.php.net/manual/en/openssl.ciphers.php
     */
